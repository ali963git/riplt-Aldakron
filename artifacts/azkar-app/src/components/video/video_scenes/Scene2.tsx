  ...
  return (
    ...
    >
      <div className="w-1/2 h-full flex flex-col justify-center px-24 z-10">
        ...
        <motion.h2 
          className="text-[4.5vw] font-display text-[#FAF6EE] leading-tight mb-6"
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-[1.8vw] text-[#FAF6EE]/80">604 صفحة مصورة عالية الدقة</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[1.8vw] text-[#FAF6EE]/80">استمع مع 16 قارئاً مميزاً</p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-1/2 h-full absolute left-0 top-0 overflow-hidden">
        <motion.div 
          className="absolute inset-0 bg-gradient-to-r from-transparent to-[#02130F] z-10"
        />
        <motion.img 
