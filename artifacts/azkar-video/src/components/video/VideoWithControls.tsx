    ...
    <div className="flex-1 flex items-center gap-1.5">
      {sceneKeys.map((key, i) => {
        ...
        return (
          ...
          >
            <div
              className="absolute inset-y-0 left-0 bg-[#D4AF37]/90 rounded-full transition-[width] duration-100"
              style={{ width: `${fill}%` }}
            />
          </button>
        );
  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'تكرار المشهد الحالي: تشغيل' : 'تكرار المشهد الحالي: إيقاف'}
        aria-pressed={locked}
      >
