  ...
  return (
    ...
    >
      <div className="relative z-10 text-center flex flex-col items-center">
        ...
        >
          <img src={`${import.meta.env.BASE_URL}images/app_logo.jpg`} alt="الذاكرون" className="w-full h-full object-cover" />
        </motion.div>

        <h1 className="text-[4vw] text-[#D4AF37] leading-tight" style={{ direction: 'rtl', fontFamily: 'var(--font-arabic-display)' }}>
        ...
        <motion.div
          className="mt-6 w-[2px] bg-gradient-to-b from-[#D4AF37] to-transparent"
