    ...
    >
      <div className="relative z-10 flex flex-col items-center">
        <motion.div
          ...
          animate={phase >= 1 ? { scale: [0.5, 1.5], opacity: [0.6, 0] } : { scale: 0.5, opacity: 0 }}
        ...
        <motion.h1
          className="text-[6vw] text-[#FAF6EE] mb-6 relative z-20"
        ...
        <motion.p
          className="text-[3vw] text-[#D4AF37] relative z-20"
